(()=>{
  ...
  iframe.dataset.pwSourceCommit='07adf1fd1b0ad5829a98b06e946fa188879d786a';
  ...
  chromeStyle.textContent=`
    ...
    @media(max-width:980px){
      #pw-tcow-parent-view-switch{top:auto;right:auto;left:10px;
        bottom:calc(12px + env(safe-area-inset-bottom,0px));
        max-width:212px;
        transform:translateY(10px) scale(.98)}
      #pw-tcow-parent-view-switch.is-visible{transform:translateY(0) scale(1)}
    ...
    @media(max-width:980px){
      #pw-tcow-parent-session-counter{
        top:calc(82px + env(safe-area-inset-top,0px));right:8px;left:auto;bottom:auto;
        min-width:0;max-width:166px;padding:6px 9px 6px;border-radius:11px;gap:1px;
        transform:translateY(-6px) scale(.98);
      }
      #pw-tcow-parent-session-counter.is-visible{transform:translateY(0) scale(1)}
      #pw-tcow-parent-session-counter .pw-live-label{font-size:7.4px;letter-spacing:.035em}
      #pw-tcow-parent-session-counter .pw-live-dot{width:6px;height:6px;flex-basis:6px}
      #pw-tcow-parent-session-counter .pw-live-value{font-size:16px;line-height:1.05}
