(()=>{
  ...
  // Warm the GitHub Pages origin before the eager iframe navigation starts.
  if(!document.head.querySelector('link[data-pw-tcow-preconnect]')){
    const preconnect=document.createElement('link');
    preconnect.rel='preconnect';
    preconnect.href='https://peaceful-world-org.github.io';
  ...
  iframe.dataset.pwSourceCommit='775e95059b059aad91a4703d1ecda4a21d3eacc4';
  ...
  function syncFloatingVisibility(){
    ...
    const counterVisible=(mobile?overlapsViewport:rect.top<counterThreshold && overlapsViewport);
