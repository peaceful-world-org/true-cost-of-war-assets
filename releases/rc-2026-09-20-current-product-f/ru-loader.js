(()=>{
  ...
  chromeStyle.textContent=`
    ...
    #pw-tcow-parent-session-counter .pw-live-note{
      margin-top:1px;color:#74766f;font:560 9.2px/1.28 Inter,system-ui,sans-serif;
    ...
    @media(max-width:980px){
      ...
      #pw-tcow-parent-session-counter .pw-live-note{font-size:8.8px}
    }
  ...
  sessionCounter.innerHTML=`
    ...
    <div class="pw-live-note">${lang==='ru'?'мировые военные расходы · темп 2025':'world military spending · 2025 rate'}</div>
  `;
