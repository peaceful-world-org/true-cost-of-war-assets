(()=>{
  ...
  chromeStyle.textContent=`
    ...
    @media(max-width:980px){
      ...
      #pw-tcow-parent-view-switch button{min-width:78px;min-height:30px;padding:5px 10px;font-size:10.5px}
    }
    ...
    @media(max-width:980px){
      #pw-tcow-parent-session-counter{
        top:calc(82px + env(safe-area-inset-top,0px));right:10px;left:auto;bottom:auto;
        min-width:184px;max-width:198px;padding:8px 10px 7px;border-radius:12px;gap:2px;
        transform:translateY(-8px) scale(.98);
      }
      #pw-tcow-parent-session-counter.is-visible{transform:translateY(0) scale(1)}
      #pw-tcow-parent-session-counter .pw-live-label{font-size:8.2px}
      #pw-tcow-parent-session-counter .pw-live-value{font-size:18px}
      #pw-tcow-parent-session-counter .pw-live-note{display:block;font-size:8.3px;line-height:1.2;white-space:nowrap}
    }
