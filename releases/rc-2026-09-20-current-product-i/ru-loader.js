(()=>{
  ...
  chromeStyle.textContent=`
    ...
    @media(max-width:980px){
      #pw-tcow-parent-view-switch{top:auto;left:auto;right:78px;
        bottom:calc(12px + env(safe-area-inset-bottom,0px));
        max-width:calc(100vw - 96px);
        transform:translateY(10px) scale(.98)}
      #pw-tcow-parent-view-switch.is-visible{transform:translateY(0) scale(1)}
      #pw-tcow-parent-view-switch button{min-width:70px;min-height:30px;padding:5px 9px;font-size:10.5px}
    }
    ...
    @media(max-width:980px){
      #pw-tcow-parent-session-counter{
        ...
        min-width:176px;max-width:196px;padding:7px 10px 6px;border-radius:12px;gap:2px;
